# yt tutorial from neuralnine, basics_ttkbootstrap
# seems to have no errors, adjusted location of vs code, stopped getting deprecation warning but started again
